package org.firstinspires.ftc.teamcode.lib.vision.dogecv;
 ...
 */
@TeleOp(name="StoneDetectionDogeCV", group="DogeCV")
            ...
            if (stoneDetector.isDetected()) {
                try {
                    for (int i = 0; i < stoneDetector.foundRectangles().size(); i++) {
                        ...
                        //telemetry.addData("Stone " + (i + 1) + " x", stoneDetector.foundRectangles().get(i).x);
                        //telemetry.addData("Stone " + (i + 1) + " y", stoneDetector.foundRectangles().get(i).y);
                    }
                } catch (Exception e) {
                    telemetry.addData("Stones", "no detecto");
                }
            }
